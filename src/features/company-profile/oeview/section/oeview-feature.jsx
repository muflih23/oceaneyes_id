...
export default function OEViewFeature() {
  ...
  return (
    <div className="flex flex-col w-full">
      <SectionLayout classNames={`items-center`}>
        <div className="grid grid-rows-2 lg:grid-cols-2 lg:grid-rows-1 w-full lg:max-w-[1320px] gap-8 rounded-lg shadow-lg p-8 lg:rounded-none lg:shadow-none lg:p-0">
          ...
          <h4 className="text-base text-textGray">
            OEView membantu Anda memahami kondisi laut dengan presisi, mempermudah keputusan, serta menghindari risiko keamanan dan kerugian operasional saat melaut
          </h4>
        </div>
      </SectionLayout>
      <SectionLayout classNames={`bg-sky-950 items-center !py-[60px] lg:!py-[80px] gap-y-10 lg:gap-y-[45px] lg:rounded-bl-[200px] lg:rounded-tr-[200px]`}>
      ...
      <SectionLayout classNames={`bg-teal-50 items-center !py-[60px] lg:!py-[80px] gap-y-10 lg:gap-y-[45px] lg:rounded-br-[200px] lg:rounded-tl-[200px]`}>
        <div className="flex flex-col w-full lg:max-w-[1320px] items-center">
          <div className="flex w-full flex-col gap-y-6 lg:flex-row lg:justify-between items-center">
            <div className="flex w-fit flex-col gap-y-4 lg:max-w-[400px] xl:max-w-[500px]">
              <SectionTitle
      ...
      <SectionLayout classNames={`bg-orange-50 items-center !py-[60px] lg:!py-[80px] gap-y-10 lg:gap-y-[45px] lg:rounded-bl-[200px] lg:rounded-tr-[200px]`}>
        <div className="flex flex-col w-full lg:max-w-[1320px] items-center">
          <div className="flex w-full flex-col gap-y-6 lg:flex-row lg:justify-between items-center">
            <div className="flex w-fit flex-col gap-y-4 lg:max-w-[400px] xl:max-w-[500px]">
              <SectionTitle
      ...
      <SectionLayout classNames={`bg-cyan-950 items-center !py-[60px] lg:!py-[80px] gap-y-10 lg:gap-y-[45px] lg:rounded-br-[200px] lg:rounded-tl-[200px]`}>
        <div className="flex flex-col w-full lg:max-w-[1320px] items-center">
          <div className="flex w-full flex-col gap-y-6 lg:flex-row lg:justify-between items-center">
            <div className="flex w-fit flex-col gap-y-4 lg:max-w-[400px] xl:max-w-[500px]">
              <SectionTitle
