...
export default function ValueSection() {
    return (
        <SectionLayout classNames={`bg-[url('../public/value_banner.webp')] bg-cover bg-center mt-[90px] !py-20 lg:!py-[90px]`}>
            <div className="flex flex-col justify-center items-center py-4 lg:py-10 gap-y-2">
                ...
                <h2 className="font-extrabold text-white text-[25px] xl:text-[40px] text-center">Leading in AI technology for Fishing Industry</h2>
            </div>
