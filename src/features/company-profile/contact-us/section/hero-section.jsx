...
function ContactHeroSection() {
  ...
  return (
    <div
      className="w-full lg:min-h-[100vh] flex justify-center pt-[90px] bg-[url('https://storage.oceaneyes.id/oceaneyes/web/about_header.webp')] bg-center lg:bg-center bg-cover bg-no-repeat"
    >
